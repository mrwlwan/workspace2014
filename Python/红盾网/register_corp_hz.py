...
from lib.models_hz import CorpModel, InvalidCodeModel, MaxCodeModel
...
class Register_corp:
    ...
    def report(self):
        ...
        self.model.report('惠州红盾网最新注册公司信息_%s.csv' % time.strftime('%Y-%m-%d'), fields=fields, rows=corps, encoder='gbk')
